        ...
        class HaDeviceModeClimateFan: public esphome::shys_m5_dial::HaDeviceMode {
            ...
            public:
                ...
                void registerHAListener() override {
                    ...
                    if (modeConfig.containsKey("fan_mode") && !manualModes) {
                        std::string attrFanModesState = "fan_modes";
                ...
                */
                void loadFanModes(JsonObject modeConfig){
                    ...
                    if (modeConfig.containsKey("fan_mode")) {
                        JsonObject fanModeConfig = modeConfig["fan_mode"];

                        if (fanModeConfig.containsKey("modes")) {
